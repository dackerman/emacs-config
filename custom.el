...
(custom-set-variables
 ...
 '(custom-safe-themes
   '("73803d7cebbc240fd6cd8a54077b8fbf0b263a25db48579f5953279986283481"
 ...
 '(notmuch-saved-searches
   '((:name "inbox" :query "tag:inbox" :key "i")
     ...
     (:name "unread newsletters" :query
            "(tag:unread and tag:newsletters)")
     (:name "unread forums" :query "(tag:unread and tag:forums)")
     (:name "recently auto-archived" :query
            "(tag:unread and tag:auto-archive and -tag:unsubscribe and date:-14d..today)")
     (:name "unread" :query "(tag:unread and tag:inbox)" :key "u")
     (:name "sent" :query "tag:sent" :key "t")
     (:name "emacs-devel" :query "tag:forums/emacs and tag:inbox" :key
            "e")))
 ...
 '(package-selected-packages
   '(request prettier cuda-mode ellama html-to-hiccup slime
             multiple-cursors keychain-environment treemacs-projectile
             nord-theme lsp-dart dart-mode zig-mode paredit
             flycheck-clj-kondo company flycheck lsp-ui lsp-mode
             glsl-mode shader-mode notmuch ace-window markdown-mode
             nix-mode rainbow-delimiters cider typescript-mode
             yaml-mode rjsx-mode web-mode exec-path-from-shell
             purescript-mode rust-mode intero haskell-mode
             helm-projectile helm projectile fzf magit dracula-theme
             darktooth-theme))
